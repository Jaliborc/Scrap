...
Scrap = LibStub('WildAddon-1.0'):NewAddon(...)
L = LibStub('AceLocale-3.0'):GetLocale('Scrap')
Search = LibStub('ItemSearch-1.3')
C = LibStub('C_Everywhere')
...
function Scrap:OnEnable()
	if DLAPI then DLAPI.DebugLog("Scrap", "Scrap:OnEnable Entered") end

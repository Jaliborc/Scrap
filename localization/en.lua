...
L.KnownMount = 'Known Mounts'
L.KnownMountTip = 'If enabled, Scrap will sell |cffff2020any|r mount that your character or warband has already collected.'
L.KnownCompanion = 'Known Companion Pets'
L.KnownCompanionTip = 'If enabled, Scrap will sell |cffff2020any|r companion pet that your character or warband has already collected.'
L.MaxCompanions = 'Only when all collected'
L.MaxCompanionsTip = 'If enabled, Scrap will sell a companion pet only if you‘ve collected the maximum number allowed of that pet species.'
L.KnownToy = 'Known Toys'
L.KnownToyTip = 'If enabled, Scrap will sell |cffff2020any|r Toy Box item that your character or warband has already collected.'

...
-- options
L.GeneralDesc = 'Более тонкая настройка Scrap. Хлам не пройдет!'
L.FiltersDesc = 'Эти опции позволяют дополнительно настроить ваш список хлама и автоматическое обнаружение хлама.'

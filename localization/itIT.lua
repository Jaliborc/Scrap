...
L.Added = 'Imposta come Cinfrusaglia: %s'
L.DestroyJunk = 'Distruggi Cinfrusaglie'
L.SellJunk = 'Vendi Cinfrusaglie'
...
L.LowConsumeTip = 'Se abilitato, Scrap venderà |cffff2020qualsiasi|r oggetto consumabile che è troppo inferiore rispetto al tuo livello.'
...
L.SafeMode = 'Modalità di Sicureza'
...
L.Unusable = 'Equipaggiamento Non Utilizabile'
...
-- tutorials
L.Tutorial_Welcome = 'Benvenuti in |cffffd200Scrap|r, la soluzione intelligente di vendita automatica di cianfrusaglie di by |cffffd200Jaliborc|r. Questa breve guida vi aiuterà ad iniziare a vendere le vostre cianfrusaglie.|n|nSarà un prezioso salvatempo, e le vostre tasche apprezzeranno. Iniziamo?'
...
L.Tutorial_Drag = 'Cosa fare per dire a Scrap di vendere o meno i vari oggetti? Semplicemente |cffffd200trascinali|r dalle tue borse sul pulsante di Scrap.|n|nAlternativamente, puoi impostare un |cffffd200Assegnazione|r tra le opzioni del |cffffd200Menù di Gioco|r. Premilo quando sei sopra l\'\oggetto.'

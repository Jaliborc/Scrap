...
L["Sell"] = "Автопродажа"
L["SellTip"] = "Если включено, Scrap будет автоматически продавать хлам когда вы посещаете торговца."
...
L["LearnTip"] = "Если включено, Scrap будет следить за тем, какие предметы вы часто продаете торговцу и автоматически считать их хламом."

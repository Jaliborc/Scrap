...
L["Junk"] = "Хлам"
L["Learn"] = "Интеллектуальное обучение"
L["LearnTip"] = "Если включено, Scrap будет следить за тем, какие предметы вы обычно продаете торговцу и автоматически считать их хламом."
...
L["GlowTip"] = "Если включено, Scrap будет подсвечивать рамки с хламом |cffBBBBBBСЕРЫМ|r цветом Scrap."
...
L["SoldJunk"] = "Вы продали свой |cffBBBBBBХлам|r за %s"

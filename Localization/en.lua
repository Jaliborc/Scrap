...
L.Sell = 'Automatically Sell'
L.SellTip = 'If enabled, Scrap will automatically sell your junk when you visit a merchant.'
...
L.MissingOptions = '"Scrap Options" could not be loaded because the addon is %s.'
L.NotJunk = 'Useful'
